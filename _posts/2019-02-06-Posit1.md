...
\\
It is interesting to note that the 128-bit (or of any length) posit answer would be not loose any correct digits if converted to the 8-bit IEEE format of the authors' design at the end.
